...
namespace Dyocense.Documentation
{
    ...
    public class DocumentationDomainSharedModule : AbpModule
    {
        public override void ConfigureServices(ServiceConfigurationContext context)
        {
            ...
            {
                options.FileSets.AddEmbedded<DocumentationDomainSharedModule>("Dyocense.Documentation");
            });

            Configure<AbpLocalizationOptions>(options =>
            {
                options.Resources
                    .Add<DocumentationResource>("en")
                    .AddBaseTypes(typeof(AbpValidationResource))
                    .AddVirtualJson("/Localization/Documentation");
                
                options.DefaultResourceType = typeof(DocumentationResource);
            });
        }
    }
}
