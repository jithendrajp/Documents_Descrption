...
namespace Dyocense.Documentation.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update DocumentationDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update DocumentationEfCoreEntityExtensionMappings to extend the IdentityUser entity
