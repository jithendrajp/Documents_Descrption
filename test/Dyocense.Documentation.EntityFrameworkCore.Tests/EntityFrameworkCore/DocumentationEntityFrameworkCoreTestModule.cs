...
namespace Dyocense.Documentation.EntityFrameworkCore
{
    [DependsOn(
        ...
        typeof(DocumentationTestBaseModule)
        )]
    public class DocumentationEntityFrameworkCoreTestModule : AbpModule
    {
        ...
        private static SqliteConnection CreateDatabaseAndGetConnection()
        {
            ...
            var options = new DbContextOptionsBuilder<DocumentationMigrationsDbContext>()
                .UseSqlite(connection)
                .Options;

            using (var context = new DocumentationMigrationsDbContext(options))
            {
